...
public class Array02 {
	...
	public static void main(String[] args) {
		 ...
		 *  	* 객체의 구성요소고 객체의 고유한 값을 저장하고 있다
		 *  	* 배열의 길이는 변경할 수 없다
		 */
		
		// new 키워드를 사용해서 빈 배열객체 생성하기
		// 빈 배열객체의 각 저장소에는 지정된 타입의 기본값으로 초기화되어 있다
		int[] arr1 = new int[3];
		double[] arr2 = new double[3];
		String[] arr3 = new String[3]; //null 객체를 참조하지 못하게하는 주소값
		
		System.out.println("천번째 배열의 길이: " + arr1.length);
